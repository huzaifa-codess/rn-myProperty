...
import { View, Text, StyleSheet, FlatList, TextInput, Modal, Image, TouchableOpacity, KeyboardAvoidingView, Platform } from "react-native";
...
const Message = () => {
    ...
    function messages() {
        ...
        return (
            <FlatList
                ...
                contentContainerStyle={{ paddingVertical: Sizes.fixPadding * 2.0, flexDirection: 'column-reverse' }}
                inverted
            />
        )
    }
    ...
    function addMessage({ message }) {
        ...
        const newMessage = {
            ...
            message: message,
            time: `${finalhour.toString().length == 1 ? `0${finalhour}` : finalhour}:${minute.toString().length == 1 ? `0${minute}` : minute} ${AmPm}`,
            isSender: true,
            isSeen: false,
        }
            ...
            <View style={styles.bottomContainerStyle}>
                <View style={styles.textFieldContainerStyle}>
                    <TextInput
                        ...
                        style={{padding:0, ...Fonts.whiteColor14Regular,paddingTop:2.0 }}
