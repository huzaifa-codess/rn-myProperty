...
const HomeScreen = () => {
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity
            activeOpacity={0.9}
            onPress={() => navigation.push('property/propertyScreen',
                {
        ...
        return (
            <View style={styles.buyAndRentButtonContainerStyle}>
                <TouchableOpacity
                    ...
                    <Text style={isBuy ? { ...Fonts.whiteColor16Bold } : { ...Fonts.primaryColor16Medium }}>
                        Buy
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity
                    ...
                    <Text style={isBuy ? { ...Fonts.primaryColor16Medium } : { ...Fonts.whiteColor16Bold }}>
                        Rent
                    </Text>
                </TouchableOpacity>
            </View>
        ...
        return (
            <View style={styles.headerStyle}>
                <View style={styles.headerContentStyle}>
                    <Text style={{ ...Fonts.primaryColor18Bold }}>MyProperty</Text>
